...
HD_PWD='C:/Users/starrynightzyq/Verilog_learning/Traffic_lights_comprehensive_experiment/Traffic_lights_comprehensive_experiment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_lights_ce.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Traffic_lights_ce.tcl
