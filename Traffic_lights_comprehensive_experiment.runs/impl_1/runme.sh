...
HD_PWD='C:/Users/starrynightzyq/Verilog_learning/Traffic_lights_comprehensive_experiment/Traffic_lights_comprehensive_experiment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_lights_ce.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Traffic_lights_ce.tcl -notrace
